    ...
    * def acl =
    """
      aclPrefix
       ...
       + createBobAccessToAuthorization(webIds.bob, testContainer.getPath(), 'acl:Read, acl:Append')
    """
    * assert testContainer.setAcl(acl)

  Scenario: Test 5.1 on URL /
