...
Scenario: Test 1.2 on URL /no-interaction
...
Scenario: Test 1.3 on URL /rs-interaction
...
Scenario: Test 1.4 on URL /nr-interaction
...
Scenario: Test 1.5 on URL /no-interaction
  * def requestUri = testContainer.getUrl() + 'no-interaction'
  Given url requestUri
  And configure headers = clients.alice.getAuthHeaders('PUT', requestUri)
...
Scenario: Test 1.6 on URL /empty-container
