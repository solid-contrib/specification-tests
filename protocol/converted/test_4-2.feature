@ignore
Feature: Modify ACL to add append only to resources as needed by the rest of the tests
Background: Setup
...
Scenario: Test 2.1 on URL /alice_share_bob.ttl.acl
